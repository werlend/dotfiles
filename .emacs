...
(ensure-package-installed 'editorconfig 'flycheck 'smart-tab 'web-mode 'php-mode 'vue-mode 'zencoding-mode 'js3-mode 'jsx-mode 'po-mode 'monokai-theme 'crontab-mode 'less-css-mode 'git-gutter 'bracketed-paste 'fiplr)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zencoding-mode web-mode vue-mode typescript-mode twig-mode smart-tab pug-mode po-mode php-mode monokai-theme less-css-mode jsx-mode js3-mode git-gutter flycheck fiplr editorconfig crontab-mode bracketed-paste)))
